...
define('online-exam-app/tests/tests.lint-test', [], function () {
  ...
  QUnit.test('unit/models/posts-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/models/posts-test.js should pass ESLint\n\n');
  });
...
define('online-exam-app/tests/unit/adapters/application-test', ['ember-qunit'], function (_emberQunit) {
  'use strict';
...
define('online-exam-app/tests/unit/controllers/login-test', ['ember-qunit'], function (_emberQunit) {
  'use strict';
...
define('online-exam-app/tests/unit/models/login-test', ['ember-qunit'], function (_emberQunit) {
  'use strict';
...
define('online-exam-app/tests/unit/routes/login-test', ['ember-qunit'], function (_emberQunit) {
  'use strict';
